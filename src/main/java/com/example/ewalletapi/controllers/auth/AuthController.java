package com.example.ewalletapi.controllers.auth;
...
public class AuthController {
    ...
    @Operation(summary = "Generates a JWT token upon successful login that will be used for Authorizations",
            description = "You will need to append the string 'Bearer ' to the token before adding it to your Authorization header. NOTE: " +
